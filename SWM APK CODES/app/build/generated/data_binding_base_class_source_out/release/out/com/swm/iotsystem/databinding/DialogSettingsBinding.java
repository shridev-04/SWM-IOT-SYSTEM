...
public final class DialogSettingsBinding implements ViewBinding {
  ...
  private DialogSettingsBinding(@NonNull LinearLayout rootView, @NonNull Button btnLogout,
      @NonNull Button btnSaveName, @NonNull EditText etUserName) {
  ...
  public static DialogSettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogSettingsBinding((LinearLayout) rootView, btnLogout, btnSaveName, etUserName);
    }
